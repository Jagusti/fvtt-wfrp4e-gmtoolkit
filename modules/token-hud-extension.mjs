        ...
        if (actor.data.type === "character") {
            ...
            hudCorruption.find("i").dblclick(async (ev) => {
                ...
                if (ev.shiftKey && ev.altKey && wfrp4eContent.core) {
                    ...
                    chatData.flavor = game.i18n.format("GMTOOLKIT.TokenHudExtension.Sufferance", {actor: actor.name, plight: game.i18n.localize("GMTOOLKIT.TokenHudExtension.WrathOfTheGods")});
                ...
                if (ev.ctrlKey && wfrp4eContent.core) {
                    ...
                    let chatData = game.wfrp4e.utility.chatDataSetup(result?.result || result, "gmroll", true)
                    chatData.flavor = game.i18n.format("GMTOOLKIT.TokenHudExtension.Sufferance", {actor: actor.name, plight: game.i18n.localize("GMTOOLKIT.TokenHudExtension.PhysicalMutation")});
                    ChatMessage.create(chatData, {});
                    ev.preventDefault();
                    ev.stopPropagation();
                    return;
                ...
                if (ev.shiftKey && wfrp4eContent.core) {
                    ...
                    let chatData = game.wfrp4e.utility.chatDataSetup(result?.result || result, "gmroll", true)
                    chatData.flavor = game.i18n.format("GMTOOLKIT.TokenHudExtension.Sufferance", {actor: actor.name, plight: game.i18n.localize("GMTOOLKIT.TokenHudExtension.MentalMutation")});
                    ChatMessage.create(chatData, {});
                    ev.preventDefault();
                    ev.stopPropagation();
                    return;
